/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5154da6f9fe548082df19bb009cc6b1a)
...
interface __BaseEnv_Env {
	...
	LINE_SECOND_BRAIN_GROUP_ID: string;
	LINE_KNOWN_SENDERS: string;
	PRESENCE: DurableObjectNamespace<import("./apps/api/src/index").PresenceHub>;
	INBOX_HUB: DurableObjectNamespace<import("./apps/api/src/index").InboxThreadHub>;
	BOARD_HUB: DurableObjectNamespace<import("./apps/api/src/index").BoardPresenceHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/api/src/index");
		durableNamespaces: "PresenceHub" | "InboxThreadHub" | "BoardPresenceHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LEAVE_ENABLED" | "APP_URL" | "DEV_AUTH" | "IMPORT_DATA_ENABLED" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "INBOX_ENC_KEY" | "VAULT_ENC_KEY" | "LINE_CHANNEL_SECRET" | "LINE_CHANNEL_ACCESS_TOKEN" | "LINE_SECOND_BRAIN_GROUP_ID" | "LINE_KNOWN_SENDERS">> {}
}
