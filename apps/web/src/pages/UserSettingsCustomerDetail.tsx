  ...
  return (
    <>
      ...
      <div className="p-3 sm:p-6 max-w-2xl space-y-4">
        <Link to="/user-settings/customers" className="text-xs text-muted hover:text-brand-700 inline-flex items-center gap-1"><ArrowLeft className="w-3 h-3" /> ทุกลูกค้า</Link>
