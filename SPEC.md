...
- [x] หน้า Daily Report ส่วน "วันนี้ทำอะไรไปบ้าง" แนะนำงานจาก **Action ที่ผู้ใช้กดในวันนั้นและตรงกับ Role ในงาน ณ เวลากดเท่านั้น**:
  - ผู้จ่ายงาน: บันทึกเพื่ออัปเดตข้อมูล, อนุมัติปิดงาน, ตีกลับให้แก้ไข
  - ผู้รับผิดชอบ: บันทึกเพื่ออัปเดตข้อมูล, รับงาน, ส่งงาน, ดึงงานกลับ
  - ผู้ตรวจงาน: บันทึกเพื่ออัปเดตข้อมูล, อนุมัติปิดงาน, ตีกลับให้แก้ไข
  - หลาย Role ในงานเดียวรวมสิทธิ์ Action เข้าด้วยกัน และแสดงไม่เกิน 1 รายการต่อ Task ต่อวัน
  - การลงเวลา, ติดดาว, คอมเมนต์, แนบไฟล์, ลาก Kanban หรือบังคับเปลี่ยนสถานะโดยไม่ผ่านปุ่มข้างต้น **ไม่ทำให้งานเข้ารายงาน**
- [x] Daily Report เป็นเมนูหลักและมีสิทธิ์เมนูแยกจาก "งานของฉัน": ทุกคนที่ได้รับสิทธิ์เห็นแท็บ **รายงานของฉัน / รายงานที่ได้รับ**; ผู้รับเห็นเฉพาะใบที่ผู้ส่งเลือกชื่อไว้ (ไม่ผูก role owner/admin), มีคิว รอตรวจ/ตรวจแล้ว/ทั้งหมด, ช่วงวันที่, สัญญาณ Blocker ก่อนเปิด และอ่านรายละเอียดพร้อมคอมเมนต์ในหน้าเดียว
- [x] หน้า **งานของฉัน** แยกแท็บ **งานที่ฉันรับผิดชอบ / งานรอตรวจของฉัน**; คิวงานรอตรวจแสดงเฉพาะงานสถานะ `waiting_for_test` ที่ผู้ใช้ถูกระบุเป็น Reviewer โดยตรง และนำออกจากคิวอัตโนมัติเมื่ออนุมัติหรือตีกลับ
